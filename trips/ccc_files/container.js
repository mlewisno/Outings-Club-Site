...
osapi.container.util.getSafeJsonValue=function(c,b,a){return(c[b]!=undefined&&c[b]!=null)?c[b]:a
};
...
osapi.container.util.newMetadataRequest=function(a){return{container:window.__CONTAINER,ids:a,fields:["iframeUrl","modulePrefs.*","needsTokenRefresh","userPrefs.*","views.preferredHeight","views.preferredWidth","expireTimeMs","responseTimeMs"]}
};
osapi.container.util.newTokenRequest=function(a){return{container:window.__CONTAINER,ids:a,fields:["token"]}
};
...
this.apiHost_=String(osapi.container.util.getSafeJsonValue(b,osapi.container.ServiceConfig.API_HOST,window.__API_URI.getOrigin()));
this.apiPath_=String(osapi.container.util.getSafeJsonValue(b,osapi.container.ServiceConfig.API_PATH,"/api/rpc/cs"));
...
c=osapi.container.util.newMetadataRequest(e);
...
osapi.container.GadgetSite=function(a){this.service_=a.service;
...
this.sites_={};
this.allowDefaultView_=Boolean(osapi.container.util.getSafeJsonValue(b,osapi.container.ContainerConfig.ALLOW_DEFAULT_VIEW,true));
this.renderCajole_=Boolean(osapi.container.util.getSafeJsonValue(b,osapi.container.ContainerConfig.RENDER_CAJOLE,false));
this.renderDebugParam_=String(osapi.container.util.getSafeJsonValue(b,osapi.container.ContainerConfig.RENDER_DEBUG_PARAM,osapi.container.ContainerConfig.RENDER_DEBUG));
var c=window.__CONTAINER_URI.getQP(this.renderDebugParam_);
this.renderDebug_=(typeof c==="undefined")?Boolean(osapi.container.util.getSafeJsonValue(b,osapi.container.ContainerConfig.RENDER_DEBUG,false)):(c==="1");
this.renderTest_=Boolean(osapi.container.util.getSafeJsonValue(b,osapi.container.ContainerConfig.RENDER_TEST,false));
this.tokenRefreshInterval_=Number(osapi.container.util.getSafeJsonValue(b,osapi.container.ContainerConfig.TOKEN_REFRESH_INTERVAL,30*60*1000));
this.navigateCallback_=String(osapi.container.util.getSafeJsonValue(b,osapi.container.ContainerConfig.NAVIGATE_CALLBACK,null));
...
var b=new osapi.container.GadgetSite({service:this.service_,navigateCallback:this.navigateCallback_,gadgetEl:c,bufferEl:d});
...
osapi.container.Container.prototype.preloadFromConfig_=function(b){var a=osapi.container.util.getSafeJsonValue(b,osapi.container.ContainerConfig.PRELOAD_METADATAS,{});
...
(function(){google.container=osapi.container;
google.container.Container.prototype.onConstructed=function(a){if(this.navigateCallback_){var b=this;gadgets.rpc.register("time_iframe",function(a){var e=window[b.navigateCallback_];if(typeof e==="function"){var c=a[google.container.NavigateTiming.ID];b.sites_[c]&&(c=b.sites_[c].getNavigateTiming()[google.container.NavigateTiming.START],b.appendTiming_(a,c,google.container.NavigateTiming.SRT),b.appendTiming_(a,c,google.container.NavigateTiming.PRT),b.appendTiming_(a,c,google.container.NavigateTiming.DL),
b.appendTiming_(a,c,google.container.NavigateTiming.OL),e(a))}})}};google.container.Container.prototype.appendTiming_=function(a,b,d){a[d]&&(a[d]-=b)};google.container.GadgetSite.prototype.onConstructed=function(){this.navigateTiming_=null};google.container.GadgetSite.prototype.onNavigateTo=function(a){this.navigateTiming_=a};google.container.GadgetSite.prototype.getNavigateTiming=function(){return this.navigateTiming_};google.container.Service.prototype.parentGetGadgetMetadata_=google.container.Service.prototype.getGadgetMetadata;
google.container.Service.prototype.onConstructed=function(a){this.aspDomain_=String(google.container.util.getSafeJsonValue(a||{},google.container.ServiceConfig.ASP_DOMAIN,"google.com"))};google.container.Service.prototype.getGadgetMetadata=function(a,b){var d=b||function(){},e=this;this.parentGetGadgetMetadata_(a,function(a){for(var b in a){var f=a[b];f.error?(f=["Failed to get metadata for gadget ",b,"."].join(""),google.container.util.warn(f)):e.processAspDomain_(f)}d(a)})};
...
(function() {var nm='TX_GadgetsCallback';if (typeof window[nm]==='function') {window[nm]();}})();(function(){var j=window['___jsl'];if(j['c']&&--j['o']<=0){j['c']();delete j['c'];delete j['o'];}})();